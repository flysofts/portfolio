    ...
    <>
      <div name="CONTACT" className={`w-full ${darkMode ? 'dark' : ''}`}>
        <div className='dark:bg-neutral-600 dark:text-white'>
          ...
          <FontAwesomeIcon icon={faArrowUp} className='absolute w-7 h-7 -top-24 right-12 cursor-pointer hover:bg-slate-300 hover:text-neutral-500 border-2 dark:bg-stone-700 dark:border-0  dark:hover:bg-red-200 dark:hover:text-gray-500 py-4 px-4 rounded-full '/>
        </div>
              </div>
            </div>         
          </div>
